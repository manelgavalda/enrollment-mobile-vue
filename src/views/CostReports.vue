      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <strong>Create Cost Report</strong>
          </div>
          <div class="card-block">
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal ">
              <div class="form-group row">
                ...
                <div class="col-lg-3 form-group">
                  <label for="report">Nom de l'informe</label>
                  <input type="text" v-model="report" id="report" name="report" class="form-control input-lg" size="1" placeholder="Nom de l'informe">
                </div>
                <div class="col-lg-3 form-group">
                  <div class="col-lg-12">
